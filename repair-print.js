      ...
      <div class="page" id="p-jobs">
        ...
        <div class="card">
          <h3>กรองรายการ <span class="sp"></span>
            ...
            <select id="fAdmin" class="mini" style="width:auto"><option value="">แอดมินทุกคน</option></select>
...
/* ---------------------------------------------------------------------
   ...
   หน้าเว็บใช้ 4 ไฟล์: index.html · repair.css · repair-ui.js · repair-print.js
...
window.addEventListener('load', () => {
  ...
  if (typeof printJob !== 'function') miss.push('repair-print.js');
...
<script src="repair-print.js"></script>
...
function refreshAdminList(){
  ...
  if (sel){
    const cur = sel.value;
    sel.innerHTML = '<option value="">แอดมินทุกคน</option>'
